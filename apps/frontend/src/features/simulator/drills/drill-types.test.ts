...
describe("scoreDrill — number normalization", () => {
  ...
  test("real-world speech recognition output scores correctly", () => {
    ...
    const challenge = makeChallenge(
      "MAYDAY MAYDAY MAYDAY THIS IS BLUE DUCK BLUE DUCK BLUE DUCK MAYDAY THIS IS BLUE DUCK POSITION FIVE ZERO DEGREES ONE ZERO MINUTES NORTH ZERO ZERO ONE DEGREES TWO FIVE MINUTES WEST FIRE IMMEDIATE ASSISTANCE ONE TWO PERSONS OVER",
    );
    const answer =
      "MAYDAY MAYDAY MAYDAY THIS IS BLUE DUCK BLUE DUCK BLUE DUCK MAYDAY THIS IS BLUE DUCK POSITION 50 DEGREES 10 MINUTES NORTH 001 DEGREES 25 MINUTES WEST FIRE IMMEDIATE ASSISTANCE 12 PERSONS OVER";
