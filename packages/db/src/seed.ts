    ...
    await db.transaction(async (tx) => {
      ...
      await tx.insert(modules).values([
        ...
        },
        {
          ...
          description: "Learn the phonetic alphabet, pro-words, call procedures, and radio ethics.",
          orderIndex: 3,
        ...
        },
        {
          ...
          questions: [
            ...
            },
            {
              ...
              correct_answer: "b",
              explanation: "In ship-to-ship calls, the called station selects the working channel.",
            },
            {
              id: "m3q6",
            ...
            },
            {
              ...
              correct_answer: "c",
              explanation: "Say 'I SPELL' before spelling out a word using the phonetic alphabet.",
            },
          ],
        },
        {
