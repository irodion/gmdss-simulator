  ...
  await db.insert(modules).values([
    {
      ...
      description: "Understand VHF radio controls, channel system, and basic operating discipline.",
      orderIndex: 1,
    ...
    },
    {
      ...
      description: "Learn about EPIRB, SART, radar reflectors, GPS, PLBs, and SAR coordination.",
      orderIndex: 4,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct_answer: "c",
          explanation: "The distress call begins with 'MAYDAY MAYDAY MAYDAY' — spoken three times.",
        },
        {
          id: "m3q3",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            { key: "b", text: "Alerting SAR authorities when an individual is in distress" },
        ...
        },
        {
          ...
          options: [
            ...
            { key: "b", text: "To coordinate search and rescue efforts at the scene" },
