...
test.describe.serial("Phase 4: AI Integration", () => {
  ...
  test("Tier 2 MAYDAY scenario with scripted responses", async ({ page }) => {
    ...
    await input.fill(
      "MAYDAY MAYDAY MAYDAY THIS IS BLUE DUCK BLUE DUCK BLUE DUCK CALLSIGN 5BCD2 MAYDAY BLUE DUCK POSITION FIVE ZERO DEGREES ZERO SIX MINUTES NORTH ZERO ZERO ONE DEGREES ONE TWO MINUTES WEST FIRE IN ENGINE ROOM REQUEST IMMEDIATE ASSISTANCE EIGHT PERSONS ON BOARD OVER",
    );
